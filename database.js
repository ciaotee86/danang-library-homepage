...
async function initializeDatabase() {
    try {
        ...
        await query.run("INSERT OR REPLACE INTO books VALUES ('book-2', 'Địa Chí Lịch Sử Đà Nẵng', 'Hội Khoa Học Lịch Sử', 'history', 'Lịch sử địa phương', 'popular', 'cover-gradient-2', 2, 'available', 5.0, 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=400&q=80', 180000, 'NXB Đà Nẵng', 2020, 'Tài liệu toàn diện ghi lại lịch sử hình thành, quá trình phát triển và các đặc trưng văn hóa xã hội đặc sắc của thành phố Đà Nẵng qua các thời kỳ.')");
